...
setwd('~/Documents/Shop-window-NOC/non-parametric-updating/2020-sims/prior-only/SJ-bandwidth')
library(dplyr)
library(ggplot2)
library(rstan)
options(mc.cores=4)
...
sj_coef_option<-1 # change this for different bandwidths (see findbw() below)
