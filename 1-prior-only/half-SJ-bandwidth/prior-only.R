...
setwd('~/Documents/Shop-window-NOC/non-parametric-updating/2020-sims/prior-only/half-SJ-bandwidth')
library(dplyr)
library(ggplot2)
library(rstan)
options(mc.cores=4)
...
sj_coef_option<-0.5 # change this for different bandwidths (see findbw() below)
